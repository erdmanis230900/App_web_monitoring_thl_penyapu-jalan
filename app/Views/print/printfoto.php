...
<body>
    ...
    <br>
    <div class="container">
        <h3 class="text-center">LAPORAN FOTO BULANAN PETUGAS PENGAWAS KEBERSIHAN <br> PENYAPU JALAN</h3>
    ...
    <div class="container">
        <?php if (!empty($data)) : ?>
            <table class="table table-bordered">
                <tr>
                    <th scope="col">Foto Sebelum Bekerja</th>
                    <th scope="col">Foto Sesudah bekerja</th>
                </tr>
                <?php foreach ($data as $item) : ?>
                    <tr>
                        <td><img src="/img/<?= $item['foto_bef']; ?>" style="max-width: 350px;"></td>
                        <td><img src="/img/<?= $item['foto_af']; ?>" style="max-width: 350px;"></td>
                    </tr>
                <?php endforeach; ?>
            </table>
        <?php endif; ?>
