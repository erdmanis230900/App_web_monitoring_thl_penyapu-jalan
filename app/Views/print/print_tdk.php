...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Print Laporan Bulanan Anggota Yang Berhalangan</h1>
    <div class="row">
        <div class="col-sm">
                ...
                <div class="col-sm">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row no-gutters">
                            ...
                            <div class="col-md">
                                <div class="card-body">
                                    <h5 class="card-title">Laporan Bulanan Anggota Yang Berhalangan</h5>
                                    <?php if (empty(user()->fullname)) : ?>
                                        <div class="alert alert-danger">
                                            Anda harus mengisi nama panjang Anda terlebih dahulu.
                                        </div>
                                    <?php else : ?>
                                        <form method="post" action="<?= base_url('laporan/print_data_berhalangan'); ?>" target="_blank">
