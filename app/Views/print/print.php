...
<body>
    ...
    <br>
    <div class="container">
        <h3 class="text-center">LAPORAN BULANAN PETUGAS PENGAWAS KEBERSIHAN <br> PENYAPU JALAN</h3>
        ...
        <?php if (!empty($data)) : ?>
            ...
            <table class="table table-bordered">
                ...
                <?php foreach ($data as $item) : ?>
                    <tr>
                        <td scope="row"><?= $i++; ?></td>
                        <td><?= $item['jalur_bef'] ?> s/d <?= $item['jalur_af'] ?> </td>
                        <td class="text-center"><?= $item['keterangan1'] ?></td>
                    </tr>
                <?php endforeach; ?>
            </table>
        <?php endif; ?>
    ...
    <div class="container">
        <button type="button" class="btn btn-success" id="print" onclick="validateAndPrint()">Print laporan</button>
    </div>
