                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    ...
                                    <?php if (in_groups('user_thl')) : ?>
                                        <a href="/thl/ubah_riwayat/<?= $detail['id']; ?>" class="btn btn-success">Ubah Data</a>
                                        <br>
                                        <br>
                                    ...
                                    <?php if (in_groups('user')) : ?>
                                        <form action="/thl/acc_kerja_ubah/<?= $detail['id']; ?>" method="POST">
                                            <input type="hidden" name="id" value="<?= $detail['id']; ?>">
                                            <input type="hidden" name="status" value="Data Pernah di Ubah/data pernah tidak disetujui">
                                    ...
                                    <?php if (in_groups('admin')) : ?>
                                        <a href="<?= base_url('thl/laporan_tidak_disetujui'); ?>" class="btn btn-primary">Kembali</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-md-5">
