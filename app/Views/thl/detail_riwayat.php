                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-success"><?= $detail['waktu_bef']; ?></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <?php if (in_groups('user')) : ?>
                                        <div class="container">
                                            <div class="row">
                                                <form action="/thl/acc_kerja/<?= $detail['id']; ?>" method="POST">
                                                    <input type="hidden" name="id" value="<?= $detail['id']; ?>">
                                                    <input type="hidden" name="status" value="Data langsung disetujui">
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <strong>Apakah data telah Valid?</strong>
                                                                </div>
                                                ...
                                                |||
                                                <a href="/thl/konfirmasi_kesalahan/<?= $detail['id']; ?>" class="btn btn-danger">Tidak Disetujui</a>
                                            </div>
                                        </div>
                                        <br>
                                        <form action="<?= base_url('thl/laporan'); ?>" method="post">
                                    ...
                                    <?php if (in_groups('admin')) : ?>
                                        <div class="container">
                                            <div class="row">
                                                <a href="<?= base_url('thl/laporan'); ?>" class="btn btn-primary" type="submit" name="submit">Kembali</a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
