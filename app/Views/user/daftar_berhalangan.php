...
<div class="container-fluid">
    ...
    <div class="row-sm">
        <div class="col-sm">
            ...
            <h1 class="h3 mb-4 text-gray-800">Anggota Yang Berhalangan</h1>
            <br>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($users as $user) : ?>
                            <tr>
                                ...
                                <td><strong><?= $user->alasan1; ?></strong></td>
                                <td><?= $user->updated_at; ?></td>
                                <td>
                                    <a href="<?= base_url('user/detail_berhalangan/' . $user->id); ?>" class="btn btn-primary">Lihat Laporan</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
